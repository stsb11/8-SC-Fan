...
- Because 2D Design can be a little flakey when importing .dxf sketches, we're going to use Adobe Illustrator.
- Open up Illustrator and create a new file. Make sure you change the =Color Mode= to =RGB=
...
- Now /shift click/ the stroke color box. You should see three vertical coloured bars. Click these to convert your sketch to RGB mode.
...
- Once you've bent your blades into place, take a phtograph of your finished fan blade.
