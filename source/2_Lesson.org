...
- What do you think the effect of changing the resistor values will be? Try out the flowchart if you can't figure it out.
...
:HTML_CONTAINER_CLASS: badge
:END:
- Use your knowledge of potentiometers to create a circuit where by a potentiometer controls the number of LEDs (from 1 to 4) that are on in the circuit. 
